module code.pypygo.com/vertex/ollie/apps/account

go 1.24.0

require (
	code.pypygo.com/vertex/devkit v1.0.3
...
require (
	github.com/kitex-contrib/obs-opentelemetry/logging/zerolog v0.0.0-20241120035129-55da83caab1b // indirect
